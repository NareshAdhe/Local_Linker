...
const Hero = () => {
  return (
    <div className="w-full h-fit flex items-start justify-center  px-6  pb-20 md:px-8">
      <div className="flex flex-col md:flex-row items-center max-w-8xl w-full mt-20">
        <div className="md:w-1/2 text-left space-y-6">
          ...
          <p className="text-lg md:text-2xl text-gray-700">
            Choose the social suite founded in deep analytics, pioneering AI,
            and the strongest customer support on the market.
          </p>
